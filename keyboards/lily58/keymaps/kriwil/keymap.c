 ...
 * | ESC  |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | ESC  |      | INS  | HOME | PGUP |      |                    |      |      | UP   |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LCTRL |      | DEL  | END  |PGDOWN| MUTE |                    | PLAY | LEFT | DOWN |RIGHT |      |      |
 * |------+------+------+------+------+------|-------|    |-------|------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  _______, XXXXXXX, KC_DEL,  KC_END,  KC_PGDN, KC_MUTE,                   KC_MPLY, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX,
