 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LCTRL |      | DEL  | END  |PGDOWN| MUTE |                    | PLAY | LEFT | DOWN |RIGHT |      |VOLDN |
 * |------+------+------+------+------+------|-------|    |-------|------+------+------+------+------+------|
 * |LSHIFT|     |       |      |       |     |       |    |       |      |      |      |      |      |RSHIFT|
 * `-----------------------------------------|-------|    |-------|-----------------------------------------'
 *                      |      | LGUI |LOWER | SPACE |    | ENTER |RAISE | RALT |      |
...
[_ADJUST] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, LCTL(LSG(KC_3)), LCTL(LSG(KC_4)),  XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
