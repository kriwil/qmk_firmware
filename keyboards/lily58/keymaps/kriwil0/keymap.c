 ...
 * | ESC  |   !  |   @  |   #  |   $  |   %  |                    |   ^  |   &  |   *  |   (  |   )  | BSPC |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LCTRL |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |CPSLCK|
 * |------+------+------+------+------+------|-------|    |-------|------+------+------+------+------+------|
...
[_LOWER] = LAYOUT(
  ...
  _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,   KC_CAPS,
...
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |      |      |PRNSCR|      |SCALE1|                   |SCALE11| PREV | NEXT |VOLDN |VOLUP |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | TAB  |      | INS  | HOME | PGUP |      |                    |      |      | UP   |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LCTRL |      | DEL  | END  |PGDOWN|      |                    |      | LEFT | DOWN |RIGHT |      |      |
 * |------+------+------+------+------+------|-------|    |-------|------+------+------+------+------+------|
 * |LSHIFT|     |       |      |      |      |  MUTE |    | PLAY  |      |      |      |      |      |RSHIFT|
 * `-----------------------------------------|-------|    |-------|-----------------------------------------'
 *                      | LALT | LGUI |LOWER | SPACE |    | ENTER |RAISE | RGUI | RALT |
 *                      `---------------------------'     '----------------------------'
 */
[_RAISE] = LAYOUT(
  _______, XXXXXXX, XXXXXXX, KC_PSCR, XXXXXXX, LSG(KC_F1),                LSG(KC_F2), KC_MPRV,  KC_MNXT, KC_VOLD, KC_VOLU, XXXXXXX,
