 ...
 */
 [_COLEMAK] = LAYOUT(
  ...
  KC_LSFT, KC_Z,     KC_X,   KC_C,    KC_V,    KC_B,    XXXXXXX, XXXXXXX, KC_K,       KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ESC,
...
[_LOWER] = LAYOUT(
  ...
  _______, KC_EQL,  KC_MINS, KC_PLUS, KC_LBRC, KC_RBRC, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, KC_UNDS, KC_PIPE, KC_BSLS, KC_RSFT,
